      ...
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-6 font-sans text-harvest-dark font-medium">
          ...
          <div className="flex items-center gap-4 pl-4 border-l border-stone-200">
            <a href="tel:+18764811654" className="flex items-center text-harvest-brown hover:text-harvest-gold transition-colors font-bold text-sm">
              <Phone className="w-4 h-4 mr-2" />
              <span>+1 (876) 481-1654</span>
            </a>
            <a href="#contact" className="px-5 py-2 bg-harvest-gold text-white rounded-full hover:bg-amber-600 transition-colors shadow-sm text-sm">
              Contact Us
            </a>
          </div>
        </nav>
        ...
        <div className="md:hidden bg-harvest-cream border-t border-stone-200 shadow-inner">
          <div className="flex flex-col p-4 space-y-4 font-sans text-harvest-dark">
            ...
            <div className="pt-4 border-t border-stone-200">
              <a href="tel:+18764811654" className="flex items-center text-harvest-brown font-bold mb-3">
